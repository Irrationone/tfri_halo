...
summarizor(metatable_full %>% select(Cohort, Age, Stage, Myo, Nodes, Chemotherapy, Radiotherapy, Brachytherapy, acc_num) %>% unique %>% select(-c(acc_num))) %>% flextable::as_flextable() %>% autofit()
```