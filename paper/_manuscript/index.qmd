...
csfit_til_HR <- summary(cox_fits_cs$os)$coefficients["TILHigh TIL","exp(coef)"]
csfit_til_lowerHR <- summary(cox_fits_cs$os)$conf.int["TILHigh TIL","lower .95"]
csfit_til_upperHR <- summary(cox_fits_cs$os)$conf.int["TILHigh TIL","upper .95"]
