...
We next assessed whether TIL subgroup was associated with survival. In univariate Kaplan-Meier analyses, there was no significant association between TIL cluster and overall, progression-free, or disease-specific survival (all *P > *`r min_lrpval`). However, TIL cluster was significantly associated with prolonged overall and disease-specific survival in multivariate Cox proportional-hazards analysis accounting for age at diagnosis, FIGO stage [@Creasman2009], and adjuvant treatment (@tbl-cox-hazards). TIL cluster was also associated with longer progression-free survival, but this was not statistically significant (P = `r pval_string(summary(cox_fits$pfs)$coefficients["TILHigh TIL", "Pr(>|z|)"])`). Age was associated with shorter overall survival. None of the adjuvant treatment modalities tested were significantly associated with longer survival. The discordance in the effect of TIL between univariate and multivariate analyses was at least partially explained by differences between limited and advanced stage disease. Univariate Kaplan-Meier analyses stratified by stage highlighted that the association between TIL cluster and survival was most pronounced in patients with stage III disease (@suppfig-km-stage). The median 5-year overall survival was `r round(km_stage3_5yr$surv[1]*100, 1)`% (95% CI, `r round(km_stage3_5yr$lower[1]*100, 1)`%-`r round(km_stage3_5yr$upper[1]*100, 1)`%) for TIL-poor stage III cancers and `r round(km_stage3_5yr$surv[2]*100, 1)`% (95% CI, `r round(km_stage3_5yr$lower[2]*100, 1)`%-`r round(km_stage3_5yr$upper[2]*100, 1)`%) for TIL-rich stage III cancers (n = 71). Comparatively, the median 5-year overall survival was `r round(km_stage1_5yr$surv[1]*100, 1)`% (95% CI, `r round(km_stage1_5yr$lower[1]*100, 1)`%-`r round(km_stage1_5yr$upper[1]*100, 1)`%) for TIL-poor stage I cancers and `r round(km_stage1_5yr$surv[2]*100, 1)`% (95% CI, `r round(km_stage1_5yr$lower[2]*100, 1)`%-`r round(km_stage1_5yr$upper[2]*100, 1)`%) for TIL-rich stage I cancers (n = 118). Neither TIL subgroup nor individual TIL densities were correlated with HER2 status by immunohistochemistry or shallow whole-genome sequencing. Thus, TILs are associated with longer survival in p53abn endometrial carcinoma. 
